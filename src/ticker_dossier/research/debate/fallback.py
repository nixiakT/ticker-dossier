"""Deterministic fallback used when model debate is unavailable."""
...
from ticker_dossier.research.reporting import _fmt_big, _fmt_number, _fmt_percent, _ratio_to_pct
