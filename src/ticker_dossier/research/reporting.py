"""Render evidence-backed research dossiers."""
from __future__ import annotations

from typing import Any

from ticker_dossier.market_data.models import Financials, NewsItem, Quote, StockSnapshot

from .analysis.frameworks import evaluate_frameworks, format_framework_results
from .analysis.indicators import format_indicators
from .analysis.quality import render_quality_gate
