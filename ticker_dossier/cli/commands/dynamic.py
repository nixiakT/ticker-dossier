"""Discover runtime slash commands from custom prompts, Skills, and MCP."""
...
from ticker_dossier.cli.commands.catalog import CompletionItem, command_names
from ticker_dossier.cli.commands.custom import CustomCommand, load_custom_commands
